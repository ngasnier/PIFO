...
export var T850HTMLRenderer = function()
{
    this.width = 0;
    this.height = 0;
    this.variable = [];
...
T850HTMLRenderer.TEMP_COLORS = [[0, 0, 0],
    [41, 0, 39],
    [70, 0, 82],
    [83, 0, 127],
    [82, 0, 169],
...
T850HTMLRenderer.prototype.render = function()
{
    var colors = T850HTMLRenderer.TEMP_COLORS;
    var str = "<table>";
    var x, y, i;
    var range;
    str += "<thead><tr><th></th>";
    ...
    for (y=0;y<this.height;y++)
    {
        ...
        for(x=0;x<this.width;x++)
        {
            ...
            var range = Math.floor(((this.variable[i]-273.15)+28)/2);
            if (range<0) range=0;
