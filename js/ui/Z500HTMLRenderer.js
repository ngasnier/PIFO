...
export var Z500HTMLRenderer = function()
{
    this.width = 0;
    this.height = 0;
    this.variable = [];
...
Z500HTMLRenderer.GEOP_COLORS = [[255, 255, 255],
    [41, 0, 39],
    [70, 0, 82],
    [83, 0, 127],
    [82, 0, 169],
...
Z500HTMLRenderer.prototype.render = function()
{
    var colors = Z500HTMLRenderer.GEOP_COLORS;
    var str = "<table>";
    str += "<thead><tr><th></th>";
    ...
    for (var y = 0; y < this.height; y++)
    {
        ...
        for (var x = 0; x < this.width; x++)
        {
            ...
            var range = Math.floor((this.variable[i] - 5000) / 40);
            if (range < 0)
                range = 0;
            else if (range > 24)
                range = 25;
