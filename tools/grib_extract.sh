...
#for valid in 000 
#do
#    wgrib2 gfs.t00z.pgrb2.0p50.f$valid -s | grep PRMSL | wgrib2 -i gfs.t00z.pgrb2.0p50.f$valid -text prmsl_$valid.txt
#    wgrib2 gfs.t00z.pgrb2.0p50.f$valid -s | grep PRES:surface | wgrib2 -i gfs.t00z.pgrb2.0p50.f$valid -text sfcprs_$valid.txt
#    wgrib2 gfs.t00z.pgrb2.0p50.f$valid -s | grep HGT:surface | wgrib2 -i gfs.t00z.pgrb2.0p50.f$valid -text sfchgt_$valid.txt
#    wgrib2 gfs.t00z.pgrb2.0p50.f$valid -s | grep TMP:surface | wgrib2 -i gfs.t00z.pgrb2.0p50.f$valid -text sfctmp_$valid.txt
#
...
#        wgrib2 gfs.t00z.pgrb2.0p50.f$valid -s | grep VVEL:$hgt | wgrib2 -i gfs.t00z.pgrb2.0p50.f$valid -text vvel_$hgt"_"$valid.txt
#	wgrib2 gfs.t00z.pgrb2.0p50.f$valid -s | grep TMP:$hgt | wgrib2 -i gfs.t00z.pgrb2.0p50.f$valid -text tmp_$hgt"_"$valid.txt
#	wgrib2 gfs.t00z.pgrb2.0p50.f$valid -s | grep RH:$hgt | wgrib2 -i gfs.t00z.pgrb2.0p50.f$valid -text rh_$hgt"_"$valid.txt
#	wgrib2 gfs.t00z.pgrb2.0p50.f$valid -s | grep ABSV:$hgt | wgrib2 -i gfs.t00z.pgrb2.0p50.f$valid -text absv_$hgt"_"$valid.txt
#    done
#done
#
#
